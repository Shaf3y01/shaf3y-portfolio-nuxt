...
<template>
  ...
  >
    <SectionHeader :title="locale.contact.header" :center="true" />
      ...
      >
        ...
        >
          ...
          >
            ...
            <span>{{ locale.contact.workTypes }}</span>
          </span>
        </div>
        ...
        >
          ...
          >
            ...
            <span>{{ locale.contact.cta.email }}</span>
          </a>
          ...
          >
            ...
            <span>{{ locale.contact.cta.downloadCV }}</span>
          </a>
        </div>
          ...
          <li>
            ...
            >
              <Icon
                ...
                aria-hidden="true"
              />
              <span>{{ locale.contact.social.github }}</span>
            </a>
          </li>
          ...
          <li>
            ...
            >
              <Icon
                ...
                aria-hidden="true"
              />
              <span>{{ locale.contact.social.linkedin }}</span>
            </a>
          </li>
